...
- Create local DMGs with `./scripts/create-dmg.sh` and verify with `./scripts/verify-dmg.sh`. `dmg_output/` is ignored and should be uploaded to GitHub Releases, not committed.
